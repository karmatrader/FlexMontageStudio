...
CHANNELS = {
    "1 ЗВЁЗДНЫЕ ТАЙНЫ TV": {
        ...
        "preserve_clip_audio": True,  # True = Сохранять аудиодорожку клипов, False = выключить аудиодорожку клипов
...
# ---====РАЗДЕЛЕНИЕ====---
    ...
    "4 Extend your life": {
        ...
        # Настройки обработки фото и видео
        "preserve_clip_audio": False,  # True = Сохранять аудиодорожку клипов, False = выключить аудиодорожку клипов
